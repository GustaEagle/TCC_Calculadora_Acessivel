...
- Cada **task** tem: ID, título, responsável sugerido, status.
...
## Sprint 1 — Bootstrap repositório e documentação

### T1.1 — Padronizar fluxo Git e prompts de sessão
...
### T1.3 — Definir convenção de branches e revisão de PR (equipe)
...
## Histórico rápido de alterações

| Data | Nota |
| ---- | ---- |
| 2026-04-18 | Criação do arquivo e Sprint 1 inicial. |
