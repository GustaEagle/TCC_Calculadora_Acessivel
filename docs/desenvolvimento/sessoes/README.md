...
- Local: esta pasta `docs/desenvolvimento/sessoes/`.
...
2. No **close-session** (prompt [`prompts/close-session.txt`](../../../prompts/close-session.txt)), incluir atualização deste registo junto com [`CONTEXT.md`](../CONTEXT.md) e [`Sprints.md`](../Sprints.md).
